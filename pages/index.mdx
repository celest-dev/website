...
{/* 
<div className="bg-[#1E1E1E] text-[#D4D4D4] p-4 rounded-lg shadow-lg font-mono text-sm overflow-x-auto">
      <pre className="whitespace-pre-wrap">
        ...
        <span className="text-[#569CD6]">import</span> ReactDOM <span className="text-[#569CD6]">from</span> <span className="text-[#CE9178]">'react-dom'</span>;

        <span className="text-[#569CD6]">function</span> <span className="text-[#DCDCAA]">App</span>() {"{"}
          <span className="text-[#569CD6]">return</span> (
            <span className="text-[#808080]">&lt;</span><span className="text-[#4EC9B0]">div</span><span className="text-[#808080]">&gt;</span>
              <span className="text-[#808080]">&lt;</span><span className="text-[#4EC9B0]">h1</span><span className="text-[#808080]">&gt;</span>Hello, World!<span className="text-[#808080]">&lt;/</span><span className="text-[#4EC9B0]">h1</span><span className="text-[#808080]">&gt;</span>
            <span className="text-[#808080]">&lt;/</span><span className="text-[#4EC9B0]">div</span><span className="text-[#808080]">&gt;</span>
          );
        {"}"}

        ReactDOM.<span className="text-[#DCDCAA]">render</span>(<span className="text-[#808080]">&lt;</span><span className="text-[#4EC9B0]">App</span> <span className="text-[#808080]">/&gt;</span>, document.<span className="text-[#DCDCAA]">getElementById</span>(<span className="text-[#CE9178]">'root'</span>));
      </pre>
    </div> */}
