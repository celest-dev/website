...
description: Terms of Service governing the use of Celest.
---
...
Teo, Inc. (dba Celest) ("**Company**", "**we**", "**our**", "**us**")
operates https://celest.dev (hereinafter referred to as "**Service**").
...
your use of our web pages located at https://celest.dev operated
by Teo, Inc.
...
[https://celest.dev/privacy](/privacy).
...
contact@celest.dev so we can try to find a solution. These Terms apply
...
## 4. Contests, Sweepstakes and Promotions [#contests]
...
renew under the exact same conditions unless you cancel it or Teo,
Inc. cancels it. You may cancel your Subscription renewal either
through your online account management page or by contacting Teo,
Inc. customer support team.

A valid payment method, including credit card, is required to process
the payment for your subscription. You shall provide Teo, Inc. with
...
authorize Teo, Inc. to charge all Subscription fees incurred through
your account to any such payment instruments.

Should automatic billing fail to occur for any reason, Teo, Inc. will
...
## 6. Free Trial [#free-trial]

Teo, Inc. may, at its sole discretion, offer a Subscription with a
...
Trial, you will not be charged by Teo, Inc. until Free Trial has
...
At any time and without notice, Teo, Inc. reserves the right to (i)
modify Terms of Service of Free Trial offer, or (ii) cancel such Free
Trial offer.

## 7. Fee Changes [#fee-changes]

Teo, Inc., in its sole discretion and at any time, may modify
...
Teo, Inc. will provide you with a reasonable prior notice of any
...
material ("**Content**"). You are responsible for Content that you
...
Teo, Inc. has the right but not the obligation to monitor and edit all
...
We may use Service Providers to monitor and analyze the use of our
Service.

**PostHog**

PostHog is a product analytics platform built for the modern
enterprise, with the differentiators of being open source and having a
broader view of the tools needed to make a product successful.

For more information about PostHog, please visit their Privacy Policy:
https://posthog.com/privacy

## 12. No Use By Minors [#no-use-by-minors]
...
property of Teo, Inc. and its licensors. Service is protected by
...
product or service without the prior written consent of Teo, Inc..

## 15. Copyright Policy [#copyright-policy]
...
to dmca@celest.dev, with the subject line: "Copyright Infringement"
...
## 16. DMCA Notice and Procedure for Copyright Infringement Claims [#dmca-notice]
...
You can contact our Copyright Agent via email at dmca@celest.dev

## 17. Error Reporting and Feedback [#error-reporting]

You may provide us either directly at contact@celest.dev or via third
...
## 18. Links To Other Web Sites [#links]

Our Service may contain links to third party web sites or services
that are not owned or controlled by Teo, Inc.

Teo, Inc. has no control over, and assumes no responsibility for the
...
YOU ACKNOWLEDGE AND AGREE THAT Teo, Inc. SHALL NOT BE RESPONSIBLE OR
...
## 19. Disclaimer Of Warranty [#disclaimer-of-warranty]
...
## 23. Changes To Service [#changes-to-service]
...
## 24. Amendments To Terms [#amendments-to-terms]
...
## 25. Waiver And Severability [#waiver-and-severability]
