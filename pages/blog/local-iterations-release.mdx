...
description: "It's with immense excitement that we write our first blog post announcing the first release of the Celest CLI, enabling you to experience Celest and build a backend locally!"
...
<div id="intro-video" className="flex items-center justify-center my-4">
