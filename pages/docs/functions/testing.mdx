...
Run your tests by navigating to your `celest/` folder in your console, and then running the following command:
...
You have now learned how to write tests for your Celest Functions. Keep reading to learn how to start 
[adding other packages](./packages.mdx) in your Celest backend.
