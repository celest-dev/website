...
interface PricingTier extends React.ComponentProps<typeof Card> {
  name: string;
  description: string;
  Icon: IconType;
  features: PricingFeature[];
  price?: number | string;
  Action: React.FC<{ posthog: PostHog }>;
}
      ...
      <AccordionItem value="project-types">
        ...
        <AccordionContent>
          <p>
            ...
            projects. Free projects have limited resources and cold starts, but
            cost you nothing to run.
          </p>
          <br />
          <p>
            Every premium project comes with an included amount of usage. If
            your project scales beyond these limits, you pay for any additional
            resources as you go.
          </p>
        </AccordionContent>
      </AccordionItem>
